...
// Read from process.env, not import.meta.env: on @astrojs/vercel/serverless,
// import.meta.env only carries build-time-inlined values, so non-PUBLIC vars
// are undefined inside the lambda at runtime.
