  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-surface-raised border-surface-border shadow-lg p-6 transition duration-200 ease-in-out",
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("text-h3 font-medium text-text-primary", className)}
      {...props}
    />
  )
}
